...
async function onRequestPost({ request, env }) {
  try {
    ...
    const result = await env.fluore_notes_db.prepare("INSERT INTO notes (id, user_id, title, content, color) VALUES (?, ?, ?, ?, ?)").bind(id, userId, title, content ?? "", color ?? null).run();
...
// ../.wrangler/tmp/pages-wudsJ0/functionsRoutes-0.869761397581862.mjs
var routes = [
  {
    routePath: "/api/notes",
    mountPath: "/api",
